// ReverbSc — vendored from DaisySP (pre-LGPL-split), namespace changed to idfk.
// See reverbsc.h for provenance and licensing. Algorithm unchanged.
...
int ReverbSc::Init(float sr)
{
    ...
    for(i = 0; i < 8; i++)
    {
        if(n_bytes > IDFK_REVERBSC_MAX_SIZE)
            return 1;
