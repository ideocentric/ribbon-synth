...
/* Pin Mappings */
const int kModulationDepthPin = A6;
const int kDistortionLevelPin = A0;
const int kChorusDepthPin = A7;
const int kTremoloSpeedPin = D13;
const int kTremoloOnPin = D14;

const int kFilterFreqPin = A1;
const int kFilterResonancePin = A5;
const int kNoiseLevelPin = A2;
const int kReverbLevelPin = A4;
const int kVolumePin = A3;
